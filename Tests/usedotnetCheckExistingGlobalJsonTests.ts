...
mockery.registerMock('azure-pipelines-task-lib/task', {
    ...
    setResourcePath: function (_resourcePath: string) { return; },
    ...
    mkdirP: function (_directoryPath: string) { return; },
    ...
    getVariable: function (variableName: string): string {
...
mockery.registerMock('./nugetinstaller', {
    NuGetInstaller: {
        installNuGet: function (_version: string): Promise<void> {
            return new Promise<void>((resolve, _reject) => {
                resolve();
            });
        }
